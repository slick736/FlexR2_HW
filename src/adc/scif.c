...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x007A, 0x007D, 0x00C6, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0B88, 0x04B0, 0x0000, 0x0000, 0x0000, 0x000A, 0x0001, 0x0C67, 0xADB7, 0x0879, 0x88FF, 0x1878, 
    /*0x0100*/ 0x9D28, 0xAE1C, 0x7003, 0x14C7, 0x705D, 0x6003, 0x14D4, 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 
    /*0x0120*/ 0x7018, 0xFB4C, 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C76, 0x14DA, 0x7001, 0x14C7, 
    /*0x0140*/ 0x705D, 0x6003, 0x14D4, 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 0x7018, 0xFB4C, 0x7003, 0xFB4C, 
    /*0x0160*/ 0xFD47, 0xFB4C, 0x1465, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C77, 0x14DA, 0x0878, 0x8801, 0x0C78, 0x0878, 0x1879, 0x8D29, 
    /*0x0180*/ 0xAE02, 0x0000, 0x0C78, 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8, 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 
...
//  cfg         input       output      state       
    0x002010E8, 0x00000000, 0x002010EC, 0x002010F0  // MuscleBattery
};
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_MUSCLE_BATTERY_TASK_ID)) {
        scifReinitIo(1, -1);
        scifReinitIo(3, -1);
    }
} // scifReinitTaskIo
