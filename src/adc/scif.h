/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     MBDual
  * - <b>Project file</b>:     C:/ti/projExamples/MBDual/MBDual.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2017-05-17 14:01:18.094
  * - <b>Computer</b>:         DESKTOP-NL1U8MJ
  * - <b>User</b>:             43498
  *
  ...
  *
  *
  * \subsection section_task_desc_muscle_battery MuscleBattery
  * No description entered
  *
  */
...
/// MuscleBattery: Task ID
#define SCIF_MUSCLE_BATTERY_TASK_ID 0


/// MuscleBattery I/O mapping: Muscle
#define SCIF_MUSCLE_BATTERY_DIO_A_MUSCLE 29
/// MuscleBattery I/O mapping: Battery
#define SCIF_MUSCLE_BATTERY_DIO_A_BATTERY 27
...
/// MuscleBattery: Task configuration structure
typedef struct {
    uint16_t bThreshold; ///< 
    uint16_t mThreshold; ///< 
} SCIF_MUSCLE_BATTERY_CFG_T;


/// MuscleBattery: Task output data structure
typedef struct {
    uint16_t batteryValue; ///< 
    uint16_t muscleValue;  ///< 
} SCIF_MUSCLE_BATTERY_OUTPUT_T;


/// MuscleBattery: Task state structure
typedef struct {
    uint16_t sampleCount;    ///< 
    uint16_t sampleCountMax; ///< 
} SCIF_MUSCLE_BATTERY_STATE_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_MUSCLE_BATTERY_CFG_T cfg;
        SCIF_MUSCLE_BATTERY_OUTPUT_T output;
        SCIF_MUSCLE_BATTERY_STATE_T state;
    } muscleBattery;
} SCIF_TASK_DATA_T;
